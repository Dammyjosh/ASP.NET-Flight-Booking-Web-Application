...
namespace Flights.Controllers
{
    ...
    public class FlightController : ControllerBase
    {
        ...
        public IEnumerable<FlightRm> Search([FromQuery] FlightSearchParameters @params)
        {
            ...
            IQueryable<Plane> flights = _entities.Flights;
        ...
        {
            var flight = _entities.Flights.SingleOrDefault(plane => plane.Id == id);
        ...
        public IActionResult Book(BookDto dto)
        {
            ...
            var flight = _entities.Flights.SingleOrDefault(plane => plane.Id == dto.FlightId);
            ...
            if (error is OverbookError)
                return Conflict(new { message = "Booking has exceeded the number of available Seats." });
